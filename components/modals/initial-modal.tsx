        ...
        <Dialog open>
            <DialogContent className="p-0 overflow-auto text-black bg-white">
                <DialogHeader className="px-6 pt-8">
                    ...
                    <DialogDescription className="text-center text-zinc-500"> Make your server personality with name and an image. You can always change it later</DialogDescription>
                </DialogHeader>
                <Form {...form}>
