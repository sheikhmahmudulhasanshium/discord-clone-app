...
export const EditChannelModal=()=>{
    ...
    //extracting potential channel type from data
                        ...
                        <FormField
                            ...
                            render={({field})=>(
                               <FormItem >
                                    ...
                                    >
                                        <FormControl>
                                            <SelectTrigger className='text-black capitalize border-0 outline-none bg-zinc-200 focus:ring-0 ring-offset-0 focus:ring-offset-0'>
